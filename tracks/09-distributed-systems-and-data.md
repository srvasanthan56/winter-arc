...
- [x] Read Ch. 1. Summary written from memory
- [x] Reliability: faults vs failures, hardware/software/human faults. Fault tolerance as a deliberate design property
- [x] Scalability: describing load with **load parameters**, describing performance with **percentiles not averages**, the Twitter fan-out case study
- [x] **Tail latency** and tail latency amplification. Head-of-line blocking at the service level
- [x] Maintainability: operability, simplicity, evolvability
- [x] **Rep:** take the load-parameter analysis and apply it to your own app from Track 03. What are *your* load parameters? Write `notes/my-app-load.md`



### Set 1.2 — Ch. 2: Data Models and Query Languages

- [x] Read Ch. 2. Relational vs document vs graph. The object-relational impedance mismatch
- [x] Schema-on-read vs schema-on-write. Locality. The document model's join problem
